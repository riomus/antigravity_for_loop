        ...
        (function() {
            ...
            window.__antigravityForLoop = {
                ...
                clickAcceptButtons: function() {
                    ...
                    if (antigravityIframe && antigravityIframe.tagName === 'IFRAME') {
                        try {
                            const frameDoc = antigravityIframe.contentDocument || antigravityIframe.contentWindow?.document;
                            const iframeDoc = frameDoc.querySelector('#cascade:first-child')||frameDoc;
                            if (iframeDoc) {
