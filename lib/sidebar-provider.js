        ...
        <body>
            ...
            <div class="section">
                ...
                <div style="margin-top: 10px;">
                    ...
                    <textarea id="pre-iteration-prompt" rows="2" style="width: 100%; margin-top: 5px; resize: vertical;" placeholder="e.g. Update state..." title="Runs before each iteration"></textarea>
                ...
                <div style="margin-top: 10px;">
                    ...
                    <textarea id="pre-start-prompt" rows="2" style="width: 100%; margin-top: 5px; resize: vertical;" placeholder="e.g. Initial setup..." title="Runs before loop starts"></textarea>
                ...
                <div style="margin-top: 10px;">
                    ...
                    <textarea id="post-iteration-prompt" rows="2" style="width: 100%; margin-top: 5px; resize: vertical;" placeholder="e.g. Analyze logs..." title="Runs after each iteration"></textarea>
                ...
                <div style="margin-top: 10px;">
                    ...
                    <textarea id="pre-stop-prompt" rows="2" style="width: 100%; margin-top: 5px; resize: vertical;" placeholder="e.g. Generate report..." title="Runs when loop finishes"></textarea>
